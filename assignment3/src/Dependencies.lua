...
gSounds = {
    ['music'] = love.audio.newSource('sounds/Undertale - Megalovania.mp3'),
    ['select'] = love.audio.newSource('sounds/select.wav'),
    ['error'] = love.audio.newSource('sounds/error.wav'),
    ['error-swap'] = love.audio.newSource('sounds/error-swap.wav'),
    ['match'] = love.audio.newSource('sounds/match.wav'),
    ['match-row'] = love.audio.newSource('sounds/match-row.wav'),
    ['pick'] = love.audio.newSource('sounds/pick.wav'),
